 ...
 *HttpRequest1 req=new HttpRequest1("http://host:port/path");
 *
...
public class HttpRequest {
    //Supported HttpRequest1 methods
    ...
    //@return HttpRequest1 this instance -> for chaining method @see line 22
    public HttpRequest prepare() throws IOException {
        prepareAll(Method.GET);
        return this;
    }
    /**
     * Prepares HttpRequest1 method with for given method, possible values: HttpRequest1.Method.POST,
     * HttpRequest1.Method.PUT, HttpRequest1.Method.GET & HttpRequest1.Method.DELETE
     *
     * @param method HttpRequest1.Method - nested enum HttpRequest1.Method constant
     * @return HttpRequest1 this instance -> for chaining method @see line 22
     * @throws IOException - should be checked by caller
     * */
